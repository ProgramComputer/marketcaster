...
const ManagedRestingBuyOrdersConfigSchema = z
  .object({
    enabled: z.boolean(),
    maximumLifetimeMinutes: z.number().int().min(1).max(15),
  })
  .strict();
  ...
  .object({
    ...
    marketSelection: z
      .object({
        ...
        minimumNearTouchBuyNotionalUsd: NonNegativeDecimalSchema.optional(),
    ...
    exchange: z
      .object({
        ...
        managedRestingBuyOrders: ManagedRestingBuyOrdersConfigSchema.default({
          enabled: false,
