...
The module can import adjacent files. It receives Decimal arithmetic,
...
- Forecasting supplies derived probabilities and a configurable agreement
  tolerance. A forecast is distinct from authoritative settlement.
